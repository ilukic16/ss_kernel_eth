...
MODULE_PARM_DESC(debug_level, "Micrel debug level; testing purposes");

#define MIC_DEBUG_MSG(...) if (debug_level == 10) \
                             printk(__VA_ARGS__); \
...
static struct phy_driver ksphy_driver[] = {
{
	...
	.phy_id_mask	= 0x00fffff0,
	.name		= "Micrel KSZ9031 Gigabit PHY 22-Aug-2016",
	.features	= (PHY_GBIT_FEATURES | SUPPORTED_Pause),
	.flags		= PHY_HAS_MAGICANEG | PHY_HAS_INTERRUPT,
